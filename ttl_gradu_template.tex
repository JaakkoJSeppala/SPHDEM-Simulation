% TTL-gradupohja: valmis runko
\documentclass[utf8,english]{ttl-gradu}
...
% --- Tiivistelmä ---
\begin{abstract}
This thesis evaluates the applicability of the coupled SPH--DEM approach for granular dampers mitigating sloshing in ship ballast tanks. ...
\end{abstract}
...
contacts, and impact-driven momentum exchange within a confined cavity~\parencite{gagnon2019review}. Their performance is strongly governed by
...
studies~\parencite{prasad2022damping}.
...
% vaihda tämä rivi vastaamaan tutkinto-ohjelmaasi, huom. genetiivi ja iso
% alkukirjain
